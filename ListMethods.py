...
# insert() - Insert an elements at the specified position
my_list.insert(0, 0)
...
print("index():", index)
# count() - Returns the number of occurrances of the specified value
count = my_list.count(2)
print("count():", count)
# reverse() - Reverse the elements of the list in place
my_list.reverse()
print("reverse():", my_list)
# sort() - sorts the element of the list in place
my_list.sort()
print("sort():", my_list)
minium = min(my_list)
print("min():", minimum)
...
maximum = max(my_list)
print("max():",maximum)
#del - Delete the element at the specified index
del my_list[2]
print("del():", my_list)
